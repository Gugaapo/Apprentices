---
{"dg-publish":true,"permalink":"/70-bestiary/sapient-species/shifters/","dgShowBacklinks":true,"dgShowLocalGraph":true,"dgShowInlineTitle":true,"dgShowFileTree":true,"dgEnableSearch":true,"dgShowToc":true,"dgShowTags":true,"noteIcon":""}
---
...
Although subjugated by the [[30_Locations/Other/Ikosian Empire\|Ikosian]]  like the other natives, shifter tribes have all retained some level of autonomy and their traditions. There is no [[30_Locations/Continents/Altazia\|Altazian]] nation that is run or primarily inhabited by shifters, and their relations to local governments are anything but smooth, but neither the shifters themselves nor the magical nobility that runs Splinter States are really interested in violent conflict with each other.

There are 12 existing shifter tribes in modern [[30_Locations/Continents/Altazia\|Altazia]]: Seal, Eagle, Pigeon, Crow, Owl, Cat, Viper, Wolf, Deer, Boar, Bear, and Fox.

*   **Seal:** Lived on the eastern coast of [[30_Locations/Continents/Altazia\|Altazia]] (now mostly [[30_Locations/Countries/Eldemar\|Eldemar]]). Deep resentment against [[30_Locations/Other/Ikosian Empire\|Ikosian]]  powers. Sided with [[40_People/NPCs/Enemies/Quatach-Ichl\|Quatach-Ichl]] in the [[20_World/History/Timeline/05_The_Necromancers_War\|Necromancer's War]]. Now scattered in the [[30_Locations/Other/Ikosian Empire\|Ikosian]] Great North or [[30_Locations/Other/Ulquaan Ibasa\|Ulquaan Ibasa]].
*   **Eagle:** Proud and independent. Fled to the Winter Mountains rather than subm[[20_World/History/Timeline/03_Twilight_and_Silence\|Silence of the Gods]]it to [[30_Locations/Other/Ikosian Empire\|Ikosian]] . Surprisingly friendly to travelers despite their remote, hostile home.
*   **Pigeon:** The only tribe that doesn't predate the [[30_Locations/Other/Ikosian Empire\|Ikosian]]  invasion. Created by an eccentric mage. Well-integrated into regular society across [[30_Locations/Continents/Altazia\|Altazia]], often treating all other pigeon shifters as kin.
...
*   **Owl:** Assimilated into regular society. Known for night operations and exploring the upper reaches of the [[30_Locations/Other/Dungeon\|Dungeon]] due to their silent flight and small size.
...
*   **Viper:** Tried to integrate into society, but their poisonous alternate form and frequent role as hired killers led to harsh suppression. Launched a short-lived rebellion during the [[20_World/History/Timeline/06_The_Splinter_Wars\|Splinter Wars]] which was brutally crushed. Now scattered and widely hated.
