...
| ---------------- | ----------------------------------------------------------------------------------------------------- |
| **00_Meta**      | Templates for character sheets, playbooks, and session logs                                           |
| **10_System**    | Core PbtA mechanics, character creation, progression, Matrix Shaping rules, crafting, and the Glossary |
| **20_World**     | World lore, history, and society                                                                      |
| **30_Locations** | Geography — continents, countries, regions, cities, and notable places                                |
| **40_People**    | NPCs, mentors, and factions                                                                           |
| **50_Magic**     | Geometric Glyphs, known Matrix Formulas, and Grimoire entries                                         |
| **60_Items**     | Weapons, armor, potions, magical focuses, crystalized mana, and artifacts                             |
| **70_Bestiary**  | Fiction-first creature statblocks and GM Moves                                                        |
