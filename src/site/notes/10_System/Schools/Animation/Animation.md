...
When you hold `Animation` in your Grimoire, you have specific fictional positioning.
...
- **Trivial (0 Ticks):** Makes a broom sweep the floor by itself. (`Lebe Gehh`)
- **Regular (1 Tick):** Makes a lantern float and follow you down a dark tunnel. (`Lebe Folg Ding`)
- **Hard (2 Ticks):** Raises a skeleton and orders it to guard a doorway; requires Necromancy. (`Lebe Leic Wach`)
- **Complex (2 Ticks):** Animates a massive stone golem to dig a tunnel or fight; requires Golemancy. (`Lebe Baut Werk`)
- **Miracle (4+ Ticks):** Breathes terrifying, permanent pseudo-sentience into a colossal dread-construct. (`Lebe Seel`)
