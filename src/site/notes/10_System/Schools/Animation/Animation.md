---
{"dg-publish":true,"permalink":"/10-system/schools/animation/animation/","tags":["rules","magic","animation"],"dgShowFileTree":true,"noteIcon":""}
---
...
This creates a fundamental ceiling: **an animated construct cannot do anything the caster could not do themselves.** A golem animated by a mage who cannot swim will drown. A homing bolt animated by a mage who cannot aim will miss. Because Animation relies so heavily on the caster’s base skills to be effective, most animators also possess one or more mundane skills (like blacksmithing, carving, or martial arts) that they work on side-by-side with their magic to make their creations more capable.

**The Economic Reality:** Animation is a highly popular field with many specialists because it allows people to effectively conjure helpers and massively improve their productivity. A skilled animator can do the work of a dozen mundane laborers.
