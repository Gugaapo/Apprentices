---
{"dg-publish":true,"permalink":"/10-system/schools/divination/chronomancy/","tags":["rules","magic","chronomancy"],"dgShowBacklinks":true,"dgShowLocalGraph":true,"dgShowInlineTitle":true,"dgShowFileTree":true,"dgEnableSearch":true,"dgShowToc":true,"dgShowTags":true,"noteIcon":""}
---
...
When Chronomancers attempt to look backward or forward in time, they are technically using highly advanced [[10_System/Schools/Divination/Divination\|Divination]]. These spells are not literal windows into time; they are incredibly complex analytical matrices that gather clues from the present environment and *guess* what happened or what will happen. Because of this, past reconstruction is often flawed, and future prediction is notoriously unreliable. The further out a Chronomancer tries to look, the more wildly inaccurate the "guess" becomes.
