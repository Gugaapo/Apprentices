...
When you hold `Soul Magic` in your Grimoire, you have specific fictional positioning.
...
- **Trivial (0 Ticks):** Causes a target's nose to bleed slightly from raw spiritual pressure. (`Reis Rinn`)
- **Regular (1 Tick):** Forces a spike of pure, unadulterated primal terror onto a target's soul. (`Reis Angs`)
- **Hard (2 Ticks):** Forces the lingering spiritual imprint of a corpse to whisper its secrets; requires Spirit Calling. (`Reis Spuk Sagt`)
- **Complex (2 Ticks):** Brands an agonizing slaver's mark directly onto an enemy's soul; requires Soul Carving. (`Reis Seel Mahl`)
- **Miracle (4+ Ticks):** Literally shreds the metaphysical soul of a target into absolute oblivion, permanently preventing any resurrection. (`Fetz Seel`)
