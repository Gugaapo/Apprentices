---
{"dg-publish":true,"permalink":"/10-system/schools/soul-magic/spirit-calling/","tags":["rules","magic","spirit-calling"],"dgShowBacklinks":true,"dgShowLocalGraph":true,"dgShowInlineTitle":true,"dgShowFileTree":true,"dgEnableSearch":true,"dgShowToc":true,"dgShowTags":true,"noteIcon":""}
---
...
While [[10_System/Schools/Dimensionalism/Summoning\|Summoning]] deals with pulling physical creatures from other places, Spirit Calling deals strictly with the incorporeal. The primary use of this discipline is binding unruly spirits (ghosts) so they cannot cause harm, or enslaving them to power magical artifacts. 

**The Overlap with Necromancy:**
Technically, Necromancy (the animation of corpses) is just a specific application of Spirit Calling. A corpse cannot animate itself; it requires a bound soul to act as the mana engine. Spirit Callers are the ones who rip these souls from the afterlife and chain them to the physical realm.
...
**Spirit Calling CANNOT:**
- Be practiced legally. It carries an automatic death sentence in Altazia.
- Create a soul from nothing. Souls are eternal and indestructible; they can only be moved, bound, or damaged.