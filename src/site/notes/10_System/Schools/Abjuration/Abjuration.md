---
{"dg-publish":true,"permalink":"/10-system/schools/abjuration/abjuration/","tags":["rules","magic","abjuration"],"dgShowBacklinks":true,"dgShowLocalGraph":true,"dgShowInlineTitle":true,"dgShowFileTree":true,"dgEnableSearch":true,"dgShowToc":true,"dgShowTags":true,"noteIcon":""}
---
...
Unlike the persistent boundaries of its Ward Specialization, core Abjuration is usually reactive or temporary. A shield spell is cast in the heat of battle to intercept an incoming fireball. A counterspell is woven in a split second to disrupt an enemy's chant. 

**What it feels like to cast:** Abjuration feels like bracing for impact. It is rigid, structured, and forceful. Counterspelling requires intense analytical speed — the mage must instantly perceive the enemy's spell structure and forcefully project the exact inversion of that structure to cause it to collapse. Shielding feels like hardening the air itself into glass or steel.
...
**Abjuration CAN:**
- Create temporary physical and magical barriers (shields, walls of force).
- Dispel, counter, or unravel active magical effects.
- Grant temporary resistance to specific types of damage or magic.
- Cleanse magical debuffs or curses from a target.

**Abjuration CANNOT:**
- Deal direct damage to enemies (except by reflecting attacks or harming highly specific magical constructs).
